...
parallelVectorSum <- function(x) {
    .Call(`_autocart_parallelVectorSum`, x)
}

matrixSqrt <- function(x) {
    .Call(`_autocart_matrixSqrt`, x)
}

parallelMatrixSqrt <- function(x) {
    .Call(`_autocart_parallelMatrixSqrt`, x)
}

getInvWeights <- function(locations, islonglat, power) {
    .Call(`_autocart_getInvWeights`, locations, islonglat, power)
}

moranI <- function(response, weights) {
    .Call(`_autocart_moranI`, response, weights)
}
