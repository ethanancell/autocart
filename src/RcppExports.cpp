...
// autocart_cpp
List autocart_cpp(NumericVector response, DataFrame data, NumericMatrix locations, double alpha, double beta, Rcpp::Nullable<Rcpp::List> control);
RcppExport SEXP _autocart_autocart_cpp(SEXP responseSEXP, SEXP dataSEXP, SEXP locationsSEXP, SEXP alphaSEXP, SEXP betaSEXP, SEXP controlSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(autocart_cpp(response, data, locations, alpha, beta, control));
...
static const R_CallMethodDef CallEntries[] = {
    {"_autocart_autocart_cpp", (DL_FUNC) &_autocart_autocart_cpp, 6},
